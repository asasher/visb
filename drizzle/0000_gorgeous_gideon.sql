...
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "visb_account"
ADD CONSTRAINT "visb_account_user_id_visb_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."visb_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "visb_session"
ADD CONSTRAINT "visb_session_user_id_visb_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."visb_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "account_user_id_idx" ON "visb_account" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "session_user_id_idx" ON "visb_session" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "track_idx" ON "visb_track_slices" USING btree ("spotify_track_id");
--> statement-breakpoint